...
if __name__ == "__main__":
    ...
    parser.add_argument('--in_dataset', default='ImageNet100-I', type=str,
                        choices=['ImageNet100-I','ImageNet100-II'], help='in-distribution dataset')
    ...
    for split in ['train', 'val']:
        with open(os.path.join('data',f'{args.in_dataset}','ImageNet100-I_class_list.txt')) as file:
