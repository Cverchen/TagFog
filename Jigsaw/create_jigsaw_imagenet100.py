...
for image,label in train_loader:
    ...
    jigsaw_image.save('datasets/ImageNet100/ImageNet100_jigsaw/'+str(index)+'.png')
    print('第{}个jiasaw图片已经生成!'.format(index))
    # jigsaw_image.save('datasets/cifar100_jigsaw/'+str(index)+'.png')
    # print('第{}个jiasaw图片已经生成!'.format(index))
    
# with open('datasets/cifar100_jigsaw/cifar100_jigsaw_50000.txt', 'w', encoding='utf-8') as f:
    # for j in range(1, 50001):
        # f.write('datasets/cifar100_jigsaw/'+str(j)+'.png,100\n')

with open('datasets/ImageNet100/ImageNet100_jigsaw.txt', 'w', encoding='utf-8') as f:
    for j in range(1, index+1):
        f.write('datasets/ImageNet100/ImageNet100_jigsaw/'+str(j)+'.png,100\n')
